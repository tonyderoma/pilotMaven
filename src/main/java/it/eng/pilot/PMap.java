...
public interface PMap<K, V> extends Map<K, V> {
	 ...
	 * corrispondente alla chiave elem solo se non c'� conflitto di chiave
	 ...
	 * identificata da name, eseguendo il metodo del bean V della lista che �
	 * annotato con @Logic e il cui attributo name � identificato dal parametro
	 * name
	 * 
	 * @param name
	 * @param args
	 ...
	 * name � identificato dal parametro name. Ritorna una nuova mappa key-value
	 * dove value � un oggetto PList<T> con T nuovo tipo derivante dal mapping
	 * 
	 * @param <T>
	 * @param name
	 * @param c
